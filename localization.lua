...
if LOCALE == "itIT" then
    ...
    L["Current"] = "Attuale"
    L["Toggle popup menu"] = "Mostra/Nascondi menu popup"
    L["Open settings"] = "Apri impostazioni"
    L["Hide tooltip/menu"] = "Nascondi tooltip/menu"
...
if LOCALE == "frFR" then
    ...
    L["Current"] = "Actuel"
    L["Toggle popup menu"] = "Basculer menu popup"
    L["Open settings"] = "Ouvrir options"
    L["Hide tooltip/menu"] = "Masquer infobulle/menu"
